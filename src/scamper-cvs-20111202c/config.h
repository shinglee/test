...
/* Define to 1 if you have the `ip6_ext' struct. */
...
/* Defined to 1 if we don't want to do any debugging */
#define NDEBUG 1
...
#define PACKAGE_BUGREPORT "mjl@luckie.org.nz"

/* Define to the full name of this package. */
#define PACKAGE_NAME "scamper"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "scamper 20111202c"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "scamper"

/* Define to the home page for this package. */
#define PACKAGE_URL ""

/* Define to the version of this package. */
#define PACKAGE_VERSION "20111202c"
...
#define VERSION "20111202c"

/* Defined to 1 if we don't want to be able generate a debugfile */
/* #undef WITHOUT_DEBUGFILE */
